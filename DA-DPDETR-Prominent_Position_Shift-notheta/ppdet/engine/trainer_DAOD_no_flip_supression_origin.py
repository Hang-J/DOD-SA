...
##################################sup- 真实标签监督   unsup- 伪标签监督   multi- DP-MSDecoder####################
                        if curr_iter >= stage3_iter: #STAGE 3
                            ...
                            # paired label processing
                            # paired_gt_bbox_vis, paired_gt_class, paired_teacher_bbox_ir = self.paired_label_processing(
                            #     data['gt_bbox_vis'],
                            #     data['gt_class'],
                            #     teacher_preds['bbox'],
                            #     teacher_preds['class'])
    ...
    def paired_label_processing(self, gt_bbox_ir, gt_class, teacher_bbox, teacher_class, iou_threshold=0.5):
        ...
        return new_gt_bbox_ir_match, new_gt_bbox_ir_unmatch, new_gt_class, new_teacher_bbox_match, new_teacher_bbox_unmatch
