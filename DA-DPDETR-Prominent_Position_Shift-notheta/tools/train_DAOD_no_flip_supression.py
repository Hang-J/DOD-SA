...
import os
import sys
os.environ['PPDET_LOG_FILE'] = 'output/output35/'
...
from ppdet.engine import Trainer, init_parallel_env, set_random_seed, init_fleet_env, Trainer_DAOD_no_flip_supression
...
def run(FLAGS, cfg):
    ...
    trainer = Trainer_DAOD_no_flip_supression(cfg, mode='train')
