...
def voc_get_image_info(annotation_root, im_id, a_path):
    filename = annotation_root.findtext('filename')

    # filename = filename.split('.')[0]+'.jpg'
    # filename = a_path.split('/')[-1].split('.')[0]+'.jpg'
...
def voc_get_coco_annotation(path,obj, label2id):
    ...
    #     x1 = float(segmentation.findtext('x1'))
    #     y1 = float(segmentation.findtext('y1'))
    #     x2 = float(segmentation.findtext('x2'))
    #     y2 = float(segmentation.findtext('y2'))
    #     x3 = float(segmentation.findtext('x3'))
    #     y3 = float(segmentation.findtext('y3'))
    #     x4 = float(segmentation.findtext('x4'))
    #     y4 = float(segmentation.findtext('y4'))
...
def voc_xmls_to_cocojson(annotation_paths, label2id, output_dir, output_file):
    ...
    for a_path in tqdm(annotation_paths):
        ...
        img_info = voc_get_image_info(ann_root, im_id, a_path)
