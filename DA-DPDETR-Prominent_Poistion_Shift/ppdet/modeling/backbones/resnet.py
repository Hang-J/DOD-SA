...
class ResNet(nn.Layer):
    ...
    def forward(self, inputs, flag = 0):
        if 'flag' in inputs.keys():
            if inputs['flag'] == 3: #do sup_cat
                x = inputs['ir_image_cat']
                #x = inputs['vis_image_cat']
            elif inputs['flag'] == 4: #do unsup_s
                x = inputs['vis_image_aug']
                #x = inputs['ir_image_aug']
            elif inputs['flag'] == 5: #do unsup_w
                x = inputs['vis_image']###这里为什么不用cat
                #x = inputs['ir_image']
            elif inputs['flag'] == 'eval':
                x = inputs['vis_image']
                #x = inputs['ir_image']#这里为什么是ir_image
            elif inputs['flag'] == 6:
                #x = inputs['ir_image_flip']
                x = inputs['vis_image_flip']
            elif inputs['flag'] == 7: #stage2 single sup
                #x = inputs['vis_image']
                x = inputs['ir_image']
            elif inputs['flag'] == 'eval_stage1':
                #x = inputs['ir_image']
                x = inputs['ir_image']
            elif inputs['flag'] == 'eval_stage1_2':
                x = inputs['vis_image']
            elif inputs['flag'] == 8: #multi branch
                if flag == 1:
                    #x = inputs['vis_image']
                    x = inputs['ir_image']
                elif flag == 2:
                    #x = inputs['ir_image_aug']
                    x = inputs['vis_image_aug']
            elif inputs['flag'] == 10: #multi branch
                if flag == 1:
                    #x = inputs['vis_image']
                    x = inputs['ir_image']
                elif flag == 2:
                    #x = inputs['ir_image_aug']
                    x = inputs['vis_image_aug']
            elif inputs['flag'] == 9: #teacher multi branch
                if flag == 1:
                    x = inputs['ir_image']
                    #x = inputs['vis_image']
                elif flag == 2:
            ...
            elif inputs['flag'] == 'eval_stage2' or inputs['flag'] == 'eval_stage3': #teacher multi branch
                if flag == 1:
                   # x = inputs['vis_image']
                    x = inputs['ir_image']
                elif flag == 2:
            ...
            elif inputs['flag'] == 'infer_paired': #teacher multi branch
                if flag == 1:
                    #x = inputs['vis_image']
                    x = inputs['ir_image']
                elif flag == 2:
